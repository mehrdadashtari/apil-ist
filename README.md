...
# لیست API  های ارائه شده توسط مارکت اپی اکو 
این صفحه سرویس های منتشر در مارکت اپی اکو وجود دارند، سرویس های معرفی شده در این صفحه در آخرین بررسی ما فعال هستند و توسط ارائه دهنده پشتیبانی میشوند.
اگر صاحب سایتی هستید که API ارائه میدهد یا سایتی میشناسید که زیرساخت میکرو سرویس دارد لطفا به ما معرفی کنید تا به مجموعه ی ما اضافه شوند.
مارکت اپی اکو جایی برای دیده شدن وب سرویس های ایرانی و مارکتی برای کسب درآمد از آنهاست.

APIهای معرفی شده در دسته بندی های خاصی مرتب شده اند و همچنین رایگان/غیررایگان بودن مدل مالی سرویس هارا مشخص میکند.

**حق مالکیت** مالکیت سرویس هایی که در این صفحه معرفی یا در سایت اپی اکو منتشر میشوند با خود سرویس دهنده خواهد بود و اپی اکو در قبال غیر فعال بودن سرویس هیچ مسئولیتی نخواهد داشت.

## نکته

:free: برای مشخص کردن سرویس‌های کاملا رایگان استفاده شده است.

:moneybag: برای مشخص کردن سرویس‌های تجاری استفاده شده است.

:free::moneybag: برای مشخص کردن سرویس‌هایی که امکان استفاده بصورت فریمیوم را دارند استفاده شده است.

:question: برای مشخص کردن سرویس‌هایی که مدل آنها مشخص نیست استفاده شده است.
...
وضعیت قیمت | لینک | موضوع
 ...
 :free::moneybag: | [API زرین پال](https://www.zarinpal.com/lab/) | سرویس درگاه پرداخت شخصی 
